...
class BetaFeedbackWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _FeedbackButton(
          emoji: '\u{1F41B}',
          label: 'Was funktioniert nicht?',
          hint: 'Bug oder Problem melden',
  ...
  Future<void> _sendFeedback(String type, String message) async {
    ...
    final url = Uri.parse('mailto:parentpeakapp@gmail.com?subject=$subject&body=$body');
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(
          ...
          children: [
            ...
            Text(hint, style: TextStyle(fontSize: 10, color: color.withValues(alpha: 0.7))),
          ],
        )),
